...
<html>
  ...
  <body>
    ...
    <div align="center" class="box">
      <h1>Oops... <font color="red" > You are wrong </font>
      </h1>
      <hr>
      ...
      <font>
      <p>
      <button type="button" class="button button1" onclick="location.href = '<?php echo $mainpage ?>' "><i class="fas fa-play"></i> Play Again</button>
    </div>
  </body>
</html>
